...
public static class PortalStrings
{
    public static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        // Fees
        ["fees.title"] = "Fees",
        ["fees.setupTitle"] = "Fee setup",
        ["fees.heads"] = "Fee heads",
        ["fees.newHead"] = "New head (e.g. Tuition)",
        ["fees.lateFine"] = "Late fine",
        ["fees.fineNone"] = "None",
        ["fees.fineFlat"] = "Flat ₹",
        ["fees.finePercent"] = "Percent",
        ["fees.add"] = "Add",
        ["fees.lateFlat"] = " (+₹{0} late)",
        ["fees.latePercent"] = " (+{0}% late)",
        ["fees.planTitle"] = "Class fee plan",
        ["fees.pickClass"] = "Pick a class to edit its plan for the current year.",
        ["fees.head"] = "Head",
        ["fees.installmentLabel"] = "Installment (e.g. Term 1)",
        ["fees.amount"] = "Amount (₹)",
        ["fees.splitHelp"] =
            "Split a head into equal installments — amounts and term due dates " +
            "are generated; adjust rows after if needed.",
        ["fees.splitTotal"] = "Total (₹)",
        ["fees.installments"] = "Installments",
        ["fees.firstDue"] = "First due",
        ["fees.monthsApart"] = "Months apart",
        ["fees.split"] = "Split",
        ["fees.addInstallment"] = "Add installment",
        ["fees.totalLabel"] = "Total: ₹{0}",
        ["fees.savePlan"] = "Save plan",
        ["fees.needSplitFields"] = "Pick a head, total, count and first due date.",
        ["fees.needLineFields"] = "Every line needs a head, a positive amount and a due date.",
        ["fees.planSaved"] = "Fee plan saved.",
        ["fees.termLabel"] = "Term {0}",
        ...
        ["notices.wholeSchoolHint"] = "Empty = whole school",
        ["notices.classOnly"] = "{0} only",
        ["notices.expires"] = "Expires (optional)",
        ["notices.pin"] = "Pin to top",
        ["notices.publishing"] = "Publishing…",
        ["notices.publishBtn"] = "Publish",
        ["notices.none"] = "No notices yet.",
        ["notices.wholeSchool"] = "Whole school",
        ["notices.expiresOn"] = " · expires {0}",
        ["notices.needTitleBody"] = "Title and message are required.",
        ["notices.published"] = "Notice published. Parents will see it in the app.",

        // Homework
        ["homework.title"] = "Homework",
        ["homework.assignTitle"] = "Assign homework",
        ["homework.subject"] = "Subject",
        ["homework.allSectionsHint"] = "Empty = all sections",
        ["homework.instructions"] = "Instructions",
        ["homework.assigning"] = "Assigning…",
        ["homework.assign"] = "Assign homework",
        ["homework.noneForClass"] = "No homework for this class yet.",
        ["homework.assigned"] = "Assigned",
        ["homework.due"] = "Due",
        ["homework.allSections"] = "All",
        ["homework.pickClass"] = "Pick a class to view and assign homework.",
        ["homework.needFields"] = "Subject, due date, title and instructions are required.",
        ["homework.assignedMsg"] = "Homework assigned. Parents can see it in the app.",
    ...
    public static readonly IReadOnlyDictionary<string, string> Te = new Dictionary<string, string>
    {
        ...
        ["common.dueDate"] = "గడువు తేదీ",

        // Fees
        ["fees.title"] = "ఫీజులు",
        ["fees.setupTitle"] = "ఫీజు సెటప్",
        ["fees.heads"] = "ఫీజు రకాలు",
        ["fees.newHead"] = "కొత్త ఫీజు రకం (ఉదా. ట్యూషన్)",
        ["fees.lateFine"] = "ఆలస్య రుసుము",
        ["fees.fineNone"] = "లేదు",
        ["fees.fineFlat"] = "ఫ్లాట్ ₹",
        ["fees.finePercent"] = "శాతం",
        ["fees.add"] = "జోడించండి",
        ["fees.lateFlat"] = " (+₹{0} ఆలస్యం)",
        ["fees.latePercent"] = " (+{0}% ఆలస్యం)",
        ["fees.planTitle"] = "తరగతి ఫీజు ప్రణాళిక",
        ["fees.pickClass"] = "ప్రస్తుత సంవత్సర ఫీజు ప్రణాళిక సవరించడానికి తరగతి ఎంచుకోండి.",
        ["fees.head"] = "ఫీజు రకం",
        ["fees.installmentLabel"] = "వాయిదా (ఉదా. టర్మ్ 1)",
        ["fees.amount"] = "మొత్తం (₹)",
        ["fees.splitHelp"] =
            "ఒక ఫీజు రకాన్ని సమాన వాయిదాలుగా విభజించండి — మొత్తాలు, గడువు తేదీలు " +
            "ఆటోమేటిక్‌గా వస్తాయి; అవసరమైతే తర్వాత సవరించవచ్చు.",
        ["fees.splitTotal"] = "మొత్తం (₹)",
        ["fees.installments"] = "వాయిదాలు",
        ["fees.firstDue"] = "మొదటి గడువు",
        ["fees.monthsApart"] = "నెలల వ్యవధి",
        ["fees.split"] = "విభజించండి",
        ["fees.addInstallment"] = "వాయిదా జోడించండి",
        ["fees.totalLabel"] = "మొత్తం: ₹{0}",
        ["fees.savePlan"] = "ప్రణాళిక సేవ్ చేయండి",
        ["fees.needSplitFields"] = "ఫీజు రకం, మొత్తం, వాయిదాల సంఖ్య, మొదటి గడువు ఎంచుకోండి.",
        ["fees.needLineFields"] = "ప్రతి లైనుకు ఫీజు రకం, ధన మొత్తం, గడువు తేదీ అవసరం.",
        ["fees.planSaved"] = "ఫీజు ప్రణాళిక సేవ్ అయింది.",
        ["fees.termLabel"] = "టర్మ్ {0}",

        // Notices
        ["notices.title"] = "ప్రకటనలు",
        ["notices.publish"] = "ప్రకటన ప్రచురించండి",
        ["notices.message"] = "సందేశం",
        ["notices.audience"] = "ఎవరి కోసం",
        ["notices.wholeSchoolHint"] = "ఖాళీ = మొత్తం పాఠశాల",
        ["notices.classOnly"] = "{0} మాత్రమే",
        ["notices.expires"] = "గడువు (ఐచ్ఛికం)",
        ["notices.pin"] = "పైన పిన్ చేయండి",
        ["notices.publishing"] = "ప్రచురిస్తోంది…",
        ["notices.publishBtn"] = "ప్రచురించండి",
        ["notices.none"] = "ఇంకా ప్రకటనలు లేవు.",
        ["notices.wholeSchool"] = "మొత్తం పాఠశాల",
        ["notices.expiresOn"] = " · గడువు {0}",
        ["notices.needTitleBody"] = "శీర్షిక మరియు సందేశం తప్పనిసరి.",
        ["notices.published"] = "ప్రకటన ప్రచురించబడింది. తల్లిదండ్రులు యాప్‌లో చూస్తారు.",

        // Homework
        ["homework.title"] = "హోంవర్క్",
        ["homework.assignTitle"] = "హోంవర్క్ ఇవ్వండి",
        ["homework.subject"] = "సబ్జెక్టు",
        ["homework.allSectionsHint"] = "ఖాళీ = అన్ని సెక్షన్లు",
        ["homework.instructions"] = "సూచనలు",
        ["homework.assigning"] = "ఇస్తోంది…",
        ["homework.assign"] = "హోంవర్క్ ఇవ్వండి",
        ["homework.noneForClass"] = "ఈ తరగతికి ఇంకా హోంవర్క్ లేదు.",
        ["homework.assigned"] = "ఇచ్చిన తేదీ",
        ["homework.due"] = "గడువు",
        ["homework.allSections"] = "అన్నీ",
        ["homework.pickClass"] = "హోంవర్క్ చూడటానికి, ఇవ్వడానికి తరగతి ఎంచుకోండి.",
        ["homework.needFields"] = "సబ్జెక్టు, గడువు తేదీ, శీర్షిక, సూచనలు తప్పనిసరి.",
        ["homework.assignedMsg"] = "హోంవర్క్ ఇవ్వబడింది. తల్లిదండ్రులు యాప్‌లో చూస్తారు.",
