...
export const en = {
  ...
  openInMaps: 'Open bus location in Maps',
  ...
  // Today's trip — the parent app's primary answer
  todayTitle: "Today’s transport",
  todayNoTransportTitle: 'No bus for this child',
  todayNoTransportBody: 'This child is not assigned to a school bus route. Contact the school office if that looks wrong.',
  todayNotStarted: 'Not started',
  todayNotStartedDetail: "The bus has not begun today’s run yet.",
  todayBusRunning: 'Bus on the way',
  todayOnBoard: 'On board',
  todayDropped: 'Heading home',
  todayCompleted: 'Completed',
  stepHome: 'Home',
  stepPickup: 'Pickup stop',
  stepEnRoute: 'On the way',
  stepSchool: 'School',
  tripLastSeen: 'Last seen',
  tripStaleWarning: 'The bus location has not updated for a few minutes. It may be in an area with poor signal.',
  morningTrip: 'Morning trip',
  afternoonTrip: 'Afternoon trip',
  greetingMorning: 'Good morning',
  greetingAfternoon: 'Good afternoon',
  greetingEvening: 'Good evening',
  tripPickupTime: 'Pickup time',
  tripDriver: 'Driver',
  tripBus: 'Bus',
  tripRoute: 'Route',
  tripStop: 'Stop',
  tripCallDriver: 'Call driver',
} as const;
...
export const te: Record<TranslationKey, string> = {
  ...
  openInMaps: 'మ్యాప్స్‌లో బస్సు లొకేషన్ చూడండి',
  ...
  // Today's trip
  todayTitle: 'ఈరోజు రవాణా',
  todayNoTransportTitle: 'ఈ విద్యార్థికి బస్సు లేదు',
  todayNoTransportBody: 'ఈ విద్యార్థి పాఠశాల బస్సు రూట్‌కు కేటాయించబడలేదు. ఇది తప్పు అనిపిస్తే పాఠశాల కార్యాలయాన్ని సంప్రదించండి.',
  todayNotStarted: 'ప్రారంభం కాలేదు',
  todayNotStartedDetail: 'బస్సు ఈరోజు ప్రయాణం ఇంకా ప్రారంభించలేదు.',
  todayBusRunning: 'బస్సు వస్తోంది',
  todayOnBoard: 'బస్సులో ఉన్నారు',
  todayDropped: 'ఇంటికి వెళ్తున్నారు',
  todayCompleted: 'పూర్తయింది',
  stepHome: 'ఇల్లు',
  stepPickup: 'పికప్ స్టాప్',
  stepEnRoute: 'ప్రయాణంలో',
  stepSchool: 'పాఠశాల',
  tripLastSeen: 'చివరిగా కనిపించింది',
  tripStaleWarning: 'బస్సు లొకేషన్ కొన్ని నిమిషాలుగా అప్‌డేట్ కాలేదు. సిగ్నల్ తక్కువ ఉన్న ప్రాంతంలో ఉండవచ్చు.',
  morningTrip: 'ఉదయం ప్రయాణం',
  afternoonTrip: 'మధ్యాహ్నం ప్రయాణం',
  greetingMorning: 'శుభోదయం',
  greetingAfternoon: 'శుభ మధ్యాహ్నం',
  greetingEvening: 'శుభ సాయంత్రం',
  tripPickupTime: 'పికప్ సమయం',
  tripDriver: 'డ్రైవర్',
  tripBus: 'బస్సు',
  tripRoute: 'రూట్',
  tripStop: 'స్టాప్',
  tripCallDriver: 'డ్రైవర్‌కు కాల్',
};
