...
- Keep builds at zero warnings; don't bump MediatR/FluentAssertions majors
  (licensing) — see `docs/security-notes.md`. No AutoMapper: mappings are
  hand-written (`*Mappings` classes).
